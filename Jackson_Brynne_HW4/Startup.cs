...
using Jackson_Brynne_HW4.Models;
using Jackson_Brynne_HW4.DAL;


namespace Jackson_Brynne_HW4
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa21jacksonbrynnehw4.database.windows.net,1433;Initial Catalog=fa21jacksonbrynnehw4;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
